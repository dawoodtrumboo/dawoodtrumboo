...
# 💻 Tech Stack:
![CSS3](https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white) ![Tailwind](<span class="bg-blue-500 text-white py-1 px-3 rounded-lg text-sm font-semibold">
  CSS3
</span>
